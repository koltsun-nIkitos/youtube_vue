<template>
  <a href="./channel.html" class="mb-7 group">
    <div class="relative">
      ...
      <span
        class="opacity-100 group-hover:opacity-0 duration-500 bg-opacity-60 absolute bottom-0 right-0 bg-black text-white rounded-sm m-1 p-1 text-sm font-semibold"
        >6:35</span
      >
    </div>
